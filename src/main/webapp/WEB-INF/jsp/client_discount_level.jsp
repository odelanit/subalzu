                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 text-lg-right">
                                        <button type="button" class="btn btn-sm btn-outline-secondary"><i
                                                data-feather="trash" class="icon-xs"></i>전체 삭제
                                        </button>
                                        <button data-toggle="modal" data-target="#register-discount" type="button"
                                                class="btn btn-sm btn-outline-primary"><i data-feather="plus"
                                                                                          class="icon-xs"></i>할인/할증율 등록
                                        </button>
                                    </div>
                                </div>
...
<div class="modal fade" id="register-discount">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group row align-items-center">
                        ...
                        <div class="col-lg-9">
                            <div class="custom-control custom-control-inline custom-radio">
                                <input class="custom-control-input" type="radio" name="discount_type" id="discount_type1">
                                <label class="custom-control-label" for="discount_type1">할인</label>
                            </div>
                            <div class="custom-control custom-control-inline custom-radio">
                                <input class="custom-control-input" type="radio" name="discount_type" id="discount_type2">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control" placeholder="예: 1등급가, 2등급가 등">
                        </div>
                    </div>
                    <div class="form-group row">
