...
<div class="container mt-5 mb-5">
    <c:forEach items="${orders}" var="order">
        <div class="row mb-5">
            <div class="col-12">
                <h3 class="text-center">거래명세표<small>(공급자 보관용)</small></h3>
                <div class="row mb-2">
                    <div class="col-6">
                ...
                <table class="table mb-0" style="border-left: solid 2px black; border-right: solid 2px black;">
                    ...
                    <tr>
                        <th>
                            <div class="row">
                                <div class="col-6">
                                    이전 잔액: ${order.shop.prevTotalBalance}원
                                </div>
                                <div class="col-6 text-right">
                                    <span class="h5">
                                        총 잔액 : ${order.shop.totalBalance}원
                                    </span>
                                </div>
                            </div>
                        </th>
                ...
                <table class="table" style="border-left: solid 2px black; border-right: solid 2px black; border-bottom: solid 2px black;">
                    <colgroup>
                        <col width="100px"/>
                        <col width="240px"/>
                        <col width="100px"/>
        ...
        <div class="row mb-5">
            <div class="col-12">
                <h3 class="text-center">거래명세표<small>(공급받는자용)</small></h3>
                <div class="row mb-2">
                    <div class="col-6">
                        <span class="mr-3">주문일자: ${order.createdAt.format(localDateTimeFormat)}</span>
                        <span>주문번호: ${order.orderCode}</span>
