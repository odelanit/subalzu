...
<%--                                        <c:forEach items="${productForm.groupPrices}" var="groupPrice">--%>
<%--                                            <tr>--%>
<%--                                                <th>${groupPrice.priceGroup.name}</th>--%>
<%--                                                <td>--%>
<%--                                                    <div class="input-group">--%>
<%--                                                        <input class="price-group form-control" type="text" value="${groupPrice.price}" readonly>--%>
<%--                                                        <div class="input-group-append">--%>
<%--                                                            <span class="input-group-text">원</span>--%>
<%--                                                        </div>--%>
<%--                                                    </div>--%>
