                            ...
                            <div class="card-body">
                                ...
                                <div class="row align-items-center mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <button type="button" onclick="printReleaseProducts()" class="btn btn-outline-secondary btn-sm">
...
<script>
    ...
    function printOrder() {
        ...
        if (ids) {
            window.open('/orders/print_order?ids='+ids, "거래명세표", "width=1301, height=700, toolbar=no, menubar=no, scrollbars=yes, resizable=yes" );
        } else {
