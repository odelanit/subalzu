                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <a href="/orders/transaction-details" class="btn btn-outline-primary">
                                            <i data-feather="file-text" class="icon-xs"></i> 거래명세표
                                        </a>
                                        <a href="/orders/release" class="btn btn-outline-secondary">
                                            <i data-feather="printer" class="icon-xs"></i> 출고지시서
                                        </a>
                                    </div>
                                    <div class="col-md-6 text-md-right mt-md-0 mt-2">
                                        <a href="/orders/create" class="btn btn-outline-danger">
                                            <i data-feather="file-plus" class="icon-xs"></i> 신규주문 등록
                                        </a>
                                    </div>
                                </div>
                                <hr>
