                    ...
                    <div class="col-md-12">
                        <nav aria-label="breadcrumb" class="float-right mt-1">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">반품내역</li>
                            </ol>
                        </nav>
                        <h4 class="mb-1 mt-0">반품 등록</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        <div id="app">
                            <return-order-create-component></return-order-create-component>
                        </div>
                    </div>
                </div>
            </div> <!-- container-fluid -->
...
<script src="${contextPath}/resources/libs/dist/js/return_order_create.js"></script>
</body>
</html>