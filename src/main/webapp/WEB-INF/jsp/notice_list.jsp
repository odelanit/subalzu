                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-sm table-hover text-center">
                                    ...
                                    <tr>
                                        <th>#</th>
                                        <th class="text-center">발송타입<br>(브랜드/거래처수)</th>
                                        <th>제목</th>
                                        <th>팝업공개</th>
                                        <th>등록일</th>
                                        <th>삭제</th>
                                            ...
                                            <td colspan="6">
                                                <nav>
                                                    <ul class="pagination justify-content-center">
                                                        <c:choose>
                                                            <c:when test="${noticePage.hasPrevious()}">
                                                                <li class="page-item">
