                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr />
                                <%--@elvariable id="noticeForm" type="com.pando.subalzu.model.Notice"--%>
                                <form:form method="post" modelAttribute="noticeForm">
                                    ...
                                    <spring:bind path="type">
                                        <div class="form-group row required align-items-center">
                                            <label class="col-form-label col-lg-2">발송타입</label>
                                            <div class="col-lg-10">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <form:radiobutton cssClass="form-check-input" path="type" value="2" id="type3" />
                                    ...
                                    <spring:bind path="popup">
                                        <div class="form-group row align-items-center">
                                            <label class="col-form-label col-lg-2">팝업 공개</label>
                                            <div class="col-lg-10">
                                    ...
                                    <spring:bind path="section">
                                        <div class="form-group row align-items-center">
                                            <label class="col-form-label col-lg-2">구분</label>
                                            <div class="col-lg-10">
                                                <form:input path="section" cssClass="form-control ${status.error ? 'is-invalid' : ''}" />
                                    ...
                                    <spring:bind path="title">
                                        <div class="form-group row align-items-center required">
                                            <label class="col-form-label col-lg-2">제목</label>
                                            <div class="col-lg-10">
                                    ...
                                    <spring:bind path="description">
                                        <div class="form-group row align-items-center required">
                                            <label class="col-form-label col-lg-2">내용</label>
                                            <div class="col-lg-10">
