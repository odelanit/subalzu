        ...
        <div class="card-body">
            ...
            <table class="table table-bordered form-table mb-5">
                    ...
                    <td colspan="3">
                        <div class="d-flex">
                            ...
                            <select class="form-control w-25" v-model="subcategory_id">
                                ...
                                <option v-for="subcategory in subcategories" :key="subcategory.id" v-bind:value="subcategory.id">{{ subcategory.name }}</option>
                            </select>
                        </div>
                    </td>
                </tr>
                ...
                <tr>
                    <th>상품이미지</th>
                    <td colspan="3">
                        <label for="upload" class="image-wrapper d-block position-relative" style="width: 150px; height: 150px; border: 2px dashed rgba(52, 58, 64, .2);">
                            <img :src="imageUrl" alt="" class="img-fluid" />
                            <span :hidden="imageUrl !== ''" style="font-size: 12px; position: absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">이미지 선택해주세요.</span>
                            <input type="file" hidden id="upload" ref="upload" accept="images/*" @change="handleFileUpload">
                        </label>
                        <button class="btn btn-danger btn-sm" @click="removeImage">삭제</button>
    ...
    export default {
        ...
        methods: {
            ...
            handleFileUpload: function () {
                ...
                this.imageFile = this.$refs.upload.files[0];
                if (this.imageFile) {
